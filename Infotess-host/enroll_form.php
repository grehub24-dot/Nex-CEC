...
<head>
    ...
    <style>
        ...
        .confirmation-card .checkmark { font-size: 4rem; color: #27ae60; margin-bottom: 15px; }
        .confirmation-card h3 { color: #27ae60; font-size: 1.8rem; margin-bottom: 10px; }
        .confirmation-card .student-name { font-size: 1.2rem; color: #333; margin-bottom: 15px; }
        .confirmation-card .enrollment-id-box {
            background: #f0fdf4;
        ...
        .confirmation-card .enrollment-id {
        ...
        .confirmation-card .instructions { color: #666; margin: 15px 0 25px; font-size: 1rem; }
        .confirmation-card .btn-proceed-payment {
        ...
        .confirmation-card .btn-proceed-payment:hover { transform: translateY(-2px); }
        .confirmation-card .btn-go-home {
            display: inline-block;
            padding: 14px 40px;
            background: #fff;
            color: #1a5276;
        ...
        .confirmation-card .btn-go-home:hover { background: #f0f7ff; }
    </style>
</head>
<body>
    <!-- Navbar -->
    ...
    <div class="enroll-form-page">
        ...
        <?php if ($showConfirmation): ?>
            <div class="confirmation-card">
                ...
                <div class="student-name">Student: <?php echo htmlspecialchars($studentName); ?></div>
                <div class="enrollment-id-box">
                    <div style="font-size:0.9rem; color:#666; margin-bottom:5px;">Your Enrollment ID</div>
                    <div class="enrollment-id"><?php echo htmlspecialchars($enrollmentId); ?></div>
                </div>
                <div class="instructions">Your Enrollment ID has been generated. Use it to complete your payment.</div>
                <a href="payment.php?enrollment_id=<?php echo urlencode($enrollmentId); ?>" class="btn-proceed-payment">
