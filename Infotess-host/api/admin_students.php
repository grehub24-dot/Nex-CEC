    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="admin_students.php" class="active"><i class="fas fa-user-graduate"></i> Students</a></li>
        ...
        <main class="main-content">
            ...
            <div id="studentModal" class="modal">
                <div class="modal-content">
                    ...
                    <form action="admin_students.php" method="POST" enctype="multipart/form-data" style="display:grid; grid-template-columns: 1fr 1fr; gap:15px; margin-top: 15px;">
            ...
            <div class="section">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:15px;">
                    ...
                    <form action="admin_students.php" method="GET" style="display:flex; gap:10px;">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="admin_edit_student.php?id=<?php echo $student['id']; ?>" class="btn-login" style="background:#f0ad4e;">Edit</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
